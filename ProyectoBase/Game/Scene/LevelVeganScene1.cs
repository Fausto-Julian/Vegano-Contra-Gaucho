...
{
    public class LevelVeganScene1 : IScene
    {
        public SceneId Id => SceneId.LevelVegan1;
        ...
        private void Finish()
        {
            ...
            GameManager.Instance.ChangeScene(_playerWin ? SceneId.LevelVegan2 : SceneId.Defeat);
        }
